...
def index():
    ...
    addDir(" [COLOR white]Movistar+[/COLOR]", plusUrl, 'showSite', os.path.join(addonPath, "movistar.png"), "yes", "yes")
    addDir(" [COLOR white]TVGuia.Es[/COLOR]", tutvguiaUrl, 'showSite', os.path.join(addonPath, "guia-tv.png"), "yes", "yes")	
    addDir(" [COLOR white]ElMundo.Es[/COLOR]", elmundoUrl, 'showSite', os.path.join(addonPath, "elmundo.png"), "yes", "yes")
    addDir(" [COLOR white]VerTele:Es[/COLOR]", verteleUrl, 'showSite', os.path.join(addonPath, "vertele.png"), "yes", "yes")
    addDir(" [COLOR white]Marca.Com Deportes[/COLOR]", marcaUrl, 'showSite', os.path.join(addonPath, "marca.png"), "yes", "yes")
    addDir(" [COLOR white]DondeVerlo.Com Deportes[/COLOR]", dondeverloUrl, 'showSite', os.path.join(addonPath, "dondeverlo.png"), "yes", "yes")	
