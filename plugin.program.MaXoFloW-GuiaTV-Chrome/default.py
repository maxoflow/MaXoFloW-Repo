...
plusUrl = "http://www.movistarplus.es/programacion-tv"
tutvguiaUrl = "http://www.tvguia.es/"
elmundoUrl ="http://www.elmundo.es/television/programacion-tv/"
verteleUrl ="http://www.vertele.com/programaciontv/"
marcaUrl ="http://www.marca.com/deporte/guia-tv.html"
dondeverloUrl ="http://dondeverlo.com/"
def index():
    ...
    addDir(" [COLOR while]PLUS.ES  MOVISTAR[/COLOR]", plusUrl, 'showSite', os.path.join(addonPath, "movistar.png"), "yes", "yes")
    addDir(" [COLOR while]GUIA.TV[/COLOR]", tutvguiaUrl, 'showSite', os.path.join(addonPath, "guia-tv.png"), "yes", "yes")	
    addDir(" [COLOR while]ELMUNDO.ES[/COLOR]", elmundoUrl, 'showSite', os.path.join(addonPath, "elmundo.png"), "yes", "yes")
    addDir(" [COLOR while]VERTELE:ES[/COLOR]", verteleUrl, 'showSite', os.path.join(addonPath, "vertele.png"), "yes", "yes")
    addDir(" [COLOR while]MARCA.COM DEPORTES[/COLOR]", marcaUrl, 'showSite', os.path.join(addonPath, "marca.png"), "yes", "yes")
    addDir(" [COLOR while]DEPORTES DONDE VERLO[/COLOR]", dondeverloUrl, 'showSite', os.path.join(addonPath, "dondeverlo.png"), "yes", "yes")	
